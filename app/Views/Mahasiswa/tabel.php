            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if (in_groups('admin')) : ?>
                        ...
                        <a href="/Mahasiswa/hapus_Mhs/<?= $m['id']; ?>" class="btn btn-danger btn-hapus">Hapus</a>
                    <?php endif; ?>
                </td>
            </tr>
        <?php endforeach; ?>
                ...
                <div class="modal-body">
                    <form action="/Mahasiswa/update_Mhs/<?= $m['id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="point" name="point" value="<?php echo $m['point'] ?>" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')">
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="badges" name="badges" value="<?php echo $m['badges'] ?>">
                            </div>
                        </div>
                </div>
